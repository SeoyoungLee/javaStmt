...
public class AndroidPhone extends IPhone{
	...
	private String size;
	private String data; // 부모클래스의 프로퍼티(속성)와 동일하게 선언
	...
	public void setData(String name, String data, String size) {
		...
		this.setCompany(BRAND);
		this.setSize(size);
		this.data = super.getCompany()+"\t"+super.isPortable()+"\t"+super.getCall(name)+"\t"+"대화면 "+this.getSize()+"로 볼 수 있다."+data+" : 카톡 메시지 전달";
